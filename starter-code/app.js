...
app.get("/random", (request, response, next) => {
  response.locals.color = colors[Math.floor(Math.random() *colors.length)];
  response.render("random-color.ejs");

});

app.get("/pink-colors-view", (request, response, next) => {
  response.locals.colors = colors;
  response.render("pink-colors-view.ejs");

});
app.get("/purple-colors-view", (request, response, next) => {
  response.locals.colors = colors;
  response.render("purple-colors-view.ejs");

});
app.get("/green-colors-view", (request, response, next) => {
  response.locals.colors = colors;
  response.render("green-colors-view.ejs");
});
